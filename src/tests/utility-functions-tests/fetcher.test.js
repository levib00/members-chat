...
// @ts-nocheck
const utils = __importStar(require("../../utility-functions/fetcher"));
describe('Fetchers are called right', () => {
    test('getFetcher is called with correct params', () => __awaiter(void 0, void 0, void 0, function* () {
        global.fetch = jest.fn(() => Promise.resolve({ status: 200, json: jest.fn(() => 'works') }));
        const getResponse = yield utils.getFetcher('localhost:3000');

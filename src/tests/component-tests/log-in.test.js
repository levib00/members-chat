...
const log_in_1 = __importDefault(require("../../components/log-in"));
...
describe('Log in', () => {
    test('shows dom and sends request on button press.', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, react_2.render)(react_1.default.createElement(react_router_dom_1.MemoryRouter, null,
            react_1.default.createElement(log_in_1.default, { setHasAuth: jest.fn(), hasAuth: false })));
...
//# sourceMappingURL=log-in.test.js.map
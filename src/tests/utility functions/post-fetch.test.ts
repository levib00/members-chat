...
*/
// @ts-nocheck
import * as utils from "../../../client/src/utility-functions/post-fetch";
...
describe("Create chat", () => {
  test('Create chat navigates to chatrooms on good response', async() => {
    ...
    await utils.submitPost(url, mockBody, e, utils.validateCreateChat, setError, setValidationError, navigate, null);
...
describe("Sign Up", () => {
  test('Submit Post navigates to home on good response', async() => {
    ...
    await utils.submitPost(url, mockBody, e, utils.validateSignUp, setError, setValidationError, navigate, null);
...
describe("Log in", () => {
  ...
  test('Sets wrong username or password message on 401 error. ', async() => {
    ...
    await utils.submitPost(url, mockBody, e, utils.validateLogIn, setError, setValidationError, navigate, setHasAuth);

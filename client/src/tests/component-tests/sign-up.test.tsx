...
describe('Sign up', () => {
  ...
  test('shows dom and sends request on button press.', async () => {
    ...
    expect(submitPost).lastCalledWith('https://levib00-chatroom.adaptable.app/api/users/sign-up', expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.anything(), null, expect.anything());
  });
});

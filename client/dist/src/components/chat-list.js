...
const ChatroomList = () => {
    ...
    const { data: user, error: userError } = (0, swr_1.default)('http://localhost:3000/users/user', fetcher_1.getFetcher);
    // Fetching chatroom data using SWR
    const { data: chatrooms } = (0, swr_1.default)('http://localhost:3000/chatrooms/', fetcher_1.getFetcher);
    ...
    return (react_1.default.createElement("div", { className: 'main chat-list-page' },
        ...
        react_1.default.createElement(react_router_dom_1.Link, { className: 'create-chat-button', to: '/members-chat/chatrooms/new' }, "Create a new chatroom"),
        (user && chatrooms)

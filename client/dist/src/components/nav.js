            ...
            react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", { hidden: isMoreHidden },
                    react_1.default.createElement("div", { className: "hamburger-menu" },
                        react_1.default.createElement(react_router_dom_1.Link, { className: 'menu-nav', to: '/log-in' }, "Log in"),
                        react_1.default.createElement(react_router_dom_1.Link, { className: 'menu-nav', to: '/sign-up' }, "Sign up"),
                ...
                react_1.default.createElement("div", { className: 'main-nav' },
                    react_1.default.createElement(react_router_dom_1.Link, { className: 'hero main-nav-button', to: '/' },
                    ...
                    react_1.default.createElement(react_router_dom_1.Link, { className: 'side-nav main-nav-button', to: '/log-in' },
                    ...
                    react_1.default.createElement(react_router_dom_1.Link, { className: 'side-nav main-nav-button', to: '/sign-up' },
            ...
            react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement("div", { className: 'main-nav' },
                    react_1.default.createElement(react_router_dom_1.Link, { className: 'hero main-nav-button', to: '/' },
                        react_1.default.createElement(react_2.default, { path: js_1.mdiHome, title: 'home', size: 1 }),
                        react_1.default.createElement("div", null, "Home")),
                    react_1.default.createElement(react_router_dom_1.Link, { className: 'main-nav-button', to: '/chatrooms' },
